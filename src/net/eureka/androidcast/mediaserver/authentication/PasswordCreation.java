...
/**
 * Called when {@link PasswordReceiver} is first created. This class checks if the password file is in the PC-Cast
 * user directory. If not a new password file is created with the default string value of "password", then stored as
 * a SHA3 encrypted key.
 * 
...
public final class PasswordCreation 
{
	...
	/**
	 * Checks if isPasswordThere equals false. If so a new SHA3 key is created from the string "password".
